...
var CucumberEventListener = exports.CucumberEventListener = function (_get__2) {
    ...
    function CucumberEventListener(eventBroadcaster) {
        ...
        eventBroadcaster.on('gherkin-document', _this.onGherkinDocument.bind(_this)).on('pickle-accepted', _this.onPickleAccepted.bind(_this)).on('test-case-prepared', _this.onTestCasePrepared.bind(_this)).on('test-step-started', _this.onTestStepStarted.bind(_this)).on('test-step-finished', _this.onTestStepFinished.bind(_this)).on('test-case-finished', _this.onTestCaseFinished.bind(_this)).on('test-run-finished', _this.onTestRunFinished.bind(_this));
        return _this;
    }
    ...
    (0, _createClass3.default)(CucumberEventListener, [{
        ...
        value: function onTestStepStarted(testStepStartedEvent) {
            ...
            var scenario = feature.children.find(function (child) {
                return _get__('compareScenenarioLineWithSourceLine')(child, sourceLocation);
            });
            var step = _get__('getStepFromFeature')(feature, testStepStartedEvent.index, sourceLocation);
        ...
        value: function onTestStepFinished(testStepFinishedEvent) {
            ...
            var step = _get__('getStepFromFeature')(feature, testStepFinishedEvent.index, sourceLocation);
...
function getStepFromFeature(feature, stepIndex, sourceLocation) {
    ...
    feature.children.forEach(function (child) {
        if (child.type.indexOf('Scenario') > -1 && !_get__('compareScenenarioLineWithSourceLine')(child, sourceLocation)) {
            return;
        }
...
function _get_original__(variableName) {
    switch (variableName) {
        case 'compareScenenarioLineWithSourceLine':
            return compareScenenarioLineWithSourceLine;
